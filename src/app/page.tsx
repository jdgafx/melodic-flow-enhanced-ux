...
export default function Home() {
  const services = [
    ...
    { icon: "💡", title: "SEO Content", href: "/services/seo-content", desc: "We research and write articles that rank well on Google. Fresh content brings in organic visitors month after month, without the cost of a big writing agency. One of the smartest ways to build authority online.", price: "Starting at $149 per article" },
